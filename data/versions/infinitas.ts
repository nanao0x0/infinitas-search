...
const data: VersionData = {
  ...
  songs: [
    ...
    {
      genre: "ROCK FUSION",
      title: "airflow -dreaming of the sky- Game Edition",
      artist: "ウッチーズ",
      bpm: {
        min: 61,
        max: 152,
    ...
    {
      genre: "HYPER POP / BREAKCORE",
      title: "ALL OK!!",
      artist: "Eagle feat.Kradness",
      bpm: {
        min: 200,
        max: null,
      },
    ...
    },
    {
      ...
      title: "GHEL NAGARAJA",
      artist: 'Nana Takahashi & BEMANI Sound Team "L.E.D."',
      bpm: {
        min: 162,
        max: null,
      },
    ...
    {
      genre: "MELODIC CONTEMPORARIDDIM",
      title: "Plea Per Phase",
      artist: "Feryquitous",
      bpm: {
        min: 150,
        max: null,
    ...
    {
      genre: "HARDSTYLE",
      title: "THE ANCIENT KING IS BACK",
    ...
    {
      genre: "SPECIAL COOKING",
      title: "100sec. Kitchen Battle!!",
    ...
    },
    {
      ...
      artist: 'BEMANI Sound Team "Risk Junk"',
      bpm: {
        min: 184,
        max: null,
      },
    ...
    {
      genre: "CHAOS TASTE",
      title: "ジオメトリック∮ティーパーティー",
      artist: "The Chattering Hatter",
      bpm: {
        min: 132,
        max: 188,
      },
